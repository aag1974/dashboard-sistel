...
# -*- coding: utf-8 -*-
"""
Dashboard SPSS UNIVERSAL - VERSÃO FINAL COM FONTE PADRONIZADA
...
- NOVO: Gráficos mostram porcentagem no eixo Y
- NOVO: Ordenação inteligente por tipo de medida:
  * Nominais: ordenadas por frequência (maior → menor)
  * Ordinais: mantêm ordem dos labels (alfabética)
  * Scale: histogramas com porcentagem
- NOVO: Textos de contagem removidos para layout mais limpo
- NOVO: "Total" nas tabelas (sem ponto)
- NOVO: Header de filtros fixo no topo da página (compacto)
- CORRIGIDO: Espaçamento definitivamente ajustado (140px + 40px margin)
- CORRIGIDO: Fonte das respostas abertas padronizada em 13px
"""

print("🌍 Dashboard SPSS UNIVERSAL - FONTE PADRONIZADA")
...
print("📊 NOVOS GRÁFICOS: Eixo Y em porcentagem")
print("🔄 ORDENAÇÃO INTELIGENTE:")
print("   • Nominais: ordenadas por frequência (maior → menor)")
print("   • Ordinais: mantêm ordem original dos labels")
print("🧹 LAYOUT LIMPO: Textos de contagem removidos")
print("📌 HEADER FIXO: Filtros sempre visíveis (compacto)")
print("✅ ESPAÇAMENTO: 140px + 40px = SEM sobreposição GARANTIDA")
print("🔤 FONTE PADRONIZADA: Respostas abertas em 13px (igual tabelas)")
print()
    ...
    <script>
        ...
        function renderStringVariable(varMeta, records) {{
            ...
            validResponses.forEach((response, index) => {{
                ...
                responseItem.style.cssText = 'padding: 12px 16px; border-bottom: 1px solid var(--border); background: white; margin-bottom: 1px; font-size: 13px;';
        ...
        function renderCategoricalVariable(varMeta, records) {{
            ...
            // Ordenação inteligente baseada no tipo de medida
            const measure = varMeta.measure || 'nominal';  // default para nominal se não especificado
            
            if (measure === 'ordinal') {{
                // Variáveis ordinais: manter ordem dos labels (alfabética)
                entries.sort((a,b) => a[0].localeCompare(b[0]));
            }} else {{
                // Variáveis nominais: ordenar por frequência (maior para menor)
...
• NOVO: Gráficos com porcentagem no eixo Y
• NOVO: Ordenação inteligente por tipo de medida
• NOVO: Layout limpo sem textos de contagem
• NOVO: Header de filtros fixo e compacto
• GARANTIDO: Espaçamento 140px+40px = SEM sobreposição
• PADRONIZADO: Fontes uniformes em 13px
...
🎨 DESIGN CLEAN: Layout leve e profissional!"""
        ...
        print("📊 NOVOS RECURSOS: Porcentagem nos gráficos + Ordenação inteligente!")
        print("🧹 LAYOUT LIMPO: Textos de contagem removidos!")
        print("📌 HEADER FIXO: Filtros sempre visíveis (compacto)!")
        print("✅ ESPAÇAMENTO GARANTIDO: 140px+40px = SEM sobreposição!")
        print("🔤 FONTE PADRONIZADA: Respostas abertas em 13px!")
        return 0
